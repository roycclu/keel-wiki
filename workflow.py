...
def start_task():
    ...
    citation_targets: list[CitationTarget] = parser_extract_citation_targets(target_page, context_before_len=300, context_after_len=10)
    ...
    web_hits: list[WebSearchEvidence] = search_web_for_citation_support(target_citation, limit=10)
    if not web_hits:
    ...
    decision_support: DecisionCitationSupport = judge_support_from_sources_by_llm(citation_target=target_citation, web_hits=web_hits)
